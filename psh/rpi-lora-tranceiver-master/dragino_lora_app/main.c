...
//	byte *rbuff = "/9j/4AAQSkZJRgABAQAAAQABAAD/2wCEAAUFBQUFBQUGBgUICAcICAsKCQkKCxEMDQwNDBEaEBMQEBMQGhcbFhUWGxcpIBwcICkvJyUnLzkzMzlHREddXX0BBQUFBQUFBQYGBQgIBwgICwoJCQoLEQwNDA0MERoQExAQExAaFxsWFRYbFykgHBwgKS8nJScvOTMzOUdER11dff/CA    BEIAUwBIgMBIgACEQEDEQH/xAA2AAEAAQUBAQAAA";

//        while(1) {
  //          txlora(rbuff, strlen((char *)rbuff));
    //        delay(50);
      //  }
    } else {
